...
let email = "jaxeco1127@arpizol.com";
let password = "Sam827@123";
let {answer} = require("./code.js");
...
.then(function () {
    ...
    let emailWillBeTypedPromise = cTab.type("input[name='username']", email, {delay:150});
    return emailWillBeTypedPromise;
})
.then(function (){
    console.log("email is typed");
    let passwordWillBeTypedPromise =cTab.type("input[type='password']", password,{delay:170} );
